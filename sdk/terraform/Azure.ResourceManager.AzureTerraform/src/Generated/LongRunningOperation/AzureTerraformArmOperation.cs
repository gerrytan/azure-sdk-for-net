...
#pragma warning disable SA1649 // File name should match first type name
    internal class AzureTerraformArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of AzureTerraformArmOperation for mocking. </summary>
        protected AzureTerraformArmOperation()
        {
        }

        internal AzureTerraformArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AzureTerraformArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "AzureTerraformArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
