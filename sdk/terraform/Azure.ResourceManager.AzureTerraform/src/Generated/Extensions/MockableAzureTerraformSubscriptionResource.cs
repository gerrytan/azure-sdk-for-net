...
using Azure.ResourceManager.AzureTerraform.Models;

namespace Azure.ResourceManager.AzureTerraform.Mocking
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class MockableAzureTerraformSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableAzureTerraformSubscriptionResource"/> class for mocking. </summary>
        protected MockableAzureTerraformSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableAzureTerraformSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableAzureTerraformSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics AzureTerraformClientClientDiagnostics => _azureTerraformClientClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.AzureTerraform", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics OperationStatusesClientDiagnostics => _operationStatusesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.AzureTerraform", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> ExportTerraformAzureTerraformClientAsync(WaitUntil waitUntil, BaseExportModel exportParameter, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = AzureTerraformClientClientDiagnostics.CreateScope("MockableAzureTerraformSubscriptionResource.ExportTerraformAzureTerraformClient");
            scope.Start();
            try
            {
                ...
                var operation = new AzureTerraformArmOperation(AzureTerraformClientClientDiagnostics, Pipeline, AzureTerraformClientRestClient.CreateExportTerraformRequest(Id.SubscriptionId, exportParameter).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation> GetOperationStatusAsync(WaitUntil waitUntil, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = OperationStatusesClientDiagnostics.CreateScope("MockableAzureTerraformSubscriptionResource.GetOperationStatus");
            scope.Start();
            try
            {
                ...
                var operation = new AzureTerraformArmOperation(OperationStatusesClientDiagnostics, Pipeline, OperationStatusesRestClient.CreateGetRequest(operationId, Id.SubscriptionId).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
